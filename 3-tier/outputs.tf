...
output "web_private_ips" {
  description = "Private IPs of web tier EC2 instances"
  value       = module.web_ec2.private_ips
}

output "app_instance_ids" {
  description = "IDs of app tier EC2 instances"
  value       = module.app_ec2.instance_ids
}

output "app_private_ips" {
  description = "Private IPs of app tier EC2 instances"
  value       = module.app_ec2.private_ips
}
